...
insert into Enterprises (id, name, type, emission_result, misc_emissions, country_id) values (4, 'Rau Inc', 'Specialty Chemicals', 0.10831, 0.03007, 23);
insert into Enterprises (id, name, type, emission_result, misc_emissions, country_id) values (5, 'Dicki, Koch and Nolan', 'Restaurants', 0.03259, 0.06598, 9);
insert into Enterprises (id, name, type, emission_result, misc_emissions, country_id) values (6, 'Goyette-Harris', 'Metal Fabrications', 0.0386, 0.01739, 22);
insert into Enterprises (id, name, type, emission_result, misc_emissions, country_id) values (7, 'Feil-Krajcik', 'Metal Fabrications', 0.09158, 0.02028, 9);
insert into Enterprises (id, name, type, emission_result, misc_emissions, country_id) values (8, 'Stamm-Kemmer', 'n/a', 0.08782, 0.045, 13);
insert into Enterprises (id, name, type, emission_result, misc_emissions, country_id) values (9, 'O''Reilly-Schumm', 'Major Banks', 0.07504, 0.02532, 29);
insert into Enterprises (id, name, type, emission_result, misc_emissions, country_id) values (10, 'Willms, Cummerata and Abshire', 'Major Pharmaceuticals', 0.10664, 0.04504, 25);
insert into Enterprises (id, name, type, emission_result, misc_emissions, country_id) values (11, 'Rolfson Group', 'Steel/Iron Ore', 0.0503, 0.0394, 7);
insert into Enterprises (id, name, type, emission_result, misc_emissions, country_id) values (12, 'Bergnaum-Osinski', 'Industrial Machinery/Components', 0.04369, 0.05265, 12);
insert into Enterprises (id, name, type, emission_result, misc_emissions, country_id) values (13, 'Sanford-Wuckert', 'Construction/Ag Equipment/Trucks', 0.0297, 0.01178, 1);
insert into Enterprises (id, name, type, emission_result, misc_emissions, country_id) values (14, 'Kirlin and Sons', 'Medical Specialities', 0.10009, 0.0795, 16);
insert into Enterprises (id, name, type, emission_result, misc_emissions, country_id) values (15, 'Hessel-Rowe', 'Biotechnology: Biological Products (No Diagnostic Substances)', 0.04416, 0.01595, 17);
insert into Enterprises (id, name, type, emission_result, misc_emissions, country_id) values (16, 'Spinka, Ziemann and Cronin', 'n/a', 0.04827, 0.02285, 16);
insert into Enterprises (id, name, type, emission_result, misc_emissions, country_id) values (17, 'Jenkins, Pagac and Gibson', 'n/a', 0.02494, 0.04056, 7);
insert into Enterprises (id, name, type, emission_result, misc_emissions, country_id) values (18, 'Boyer-Heller', 'Package Goods/Cosmetics', 0.08924, 0.02481, 30);
insert into Enterprises (id, name, type, emission_result, misc_emissions, country_id) values (19, 'Morissette Group', 'Major Banks', 0.03168, 0.04876, 18);
insert into Enterprises (id, name, type, emission_result, misc_emissions, country_id) values (20, 'Little, Hintz and Blanda', 'n/a', 0.07561, 0.10226, 25);
insert into Enterprises (id, name, type, emission_result, misc_emissions, country_id) values (21, 'Kuhlman-Vandervort', 'Telecommunications Equipment', 0.05408, 0.04548, 22);
insert into Enterprises (id, name, type, emission_result, misc_emissions, country_id) values (22, 'Harvey, Mann and Carter', 'Major Pharmaceuticals', 0.05748, 0.05125, 2);
insert into Enterprises (id, name, type, emission_result, misc_emissions, country_id) values (23, 'Bruen, Beier and Bins', 'Apparel', 0.04154, 0.10384, 17);
insert into Enterprises (id, name, type, emission_result, misc_emissions, country_id) values (24, 'Keebler and Sons', 'Specialty Chemicals', 0.07983, 0.05431, 30);
insert into Enterprises (id, name, type, emission_result, misc_emissions, country_id) values (25, 'Turcotte, Baumbach and Cruickshank', 'Oil & Gas Production', 0.07671, 0.00413, 26);
insert into Enterprises (id, name, type, emission_result, misc_emissions, country_id) values (26, 'Kozey Inc', 'Major Pharmaceuticals', 0.04877, 0.05286, 14);
insert into Enterprises (id, name, type, emission_result, misc_emissions, country_id) values (27, 'Pagac, Stiedemann and Cormier', 'Major Pharmaceuticals', 0.08622, 0.04554, 16);
insert into Enterprises (id, name, type, emission_result, misc_emissions, country_id) values (28, 'Effertz Group', 'Real Estate Investment Trusts', 0.05617, 0.0827, 20);
insert into Enterprises (id, name, type, emission_result, misc_emissions, country_id) values (29, 'O''Reilly-Kulas', 'Real Estate Investment Trusts', 0.10163, 0.10885, 10);
insert into Enterprises (id, name, type, emission_result, misc_emissions, country_id) values (30, 'Schoen and Sons', 'n/a', 0.02089, 0.06203, 28);
insert into Enterprises (id, name, type, emission_result, misc_emissions, country_id) values (31, 'Schoen Group', 'Medical/Nursing Services', 0.06484, 0.08007, 9);
insert into Enterprises (id, name, type, emission_result, misc_emissions, country_id) values (32, 'Kris-Kreiger', 'n/a', 0.04461, 0.0358, 4);
insert into Enterprises (id, name, type, emission_result, misc_emissions, country_id) values (33, 'D''Amore Inc', 'n/a', 0.05681, 0.10285, 19);
insert into Enterprises (id, name, type, emission_result, misc_emissions, country_id) values (34, 'Bernhard and Sons', 'n/a', 0.07331, 0.07488, 9);
insert into Enterprises (id, name, type, emission_result, misc_emissions, country_id) values (35, 'Tillman-Kerluke', 'Television Services', 0.10595, 0.09953, 22);
insert into Enterprises (id, name, type, emission_result, misc_emissions, country_id) values (36, 'Kuphal and Sons', 'n/a', 0.04639, 0.08051, 14);
insert into Enterprises (id, name, type, emission_result, misc_emissions, country_id) values (37, 'Nitzsche, Keebler and Mitchell', 'Major Pharmaceuticals', 0.03214, 0.09654, 11);
insert into Enterprises (id, name, type, emission_result, misc_emissions, country_id) values (38, 'Kuvalis, Witting and Lockman', 'Biotechnology: Biological Products (No Diagnostic Substances)', 0.08446, 0.09105, 21);
insert into Enterprises (id, name, type, emission_result, misc_emissions, country_id) values (39, 'Legros LLC', 'Packaged Foods', 0.08871, 0.09572, 29);
insert into Enterprises (id, name, type, emission_result, misc_emissions, country_id) values (40, 'Willms Inc', 'Real Estate Investment Trusts', 0.05577, 0.03427, 29);
insert into Enterprises (id, name, type, emission_result, misc_emissions, country_id) values (41, 'Bode-Fadel', 'Precious Metals', 0.04988, 0.03419, 12);
insert into Enterprises (id, name, type, emission_result, misc_emissions, country_id) values (42, 'Frami LLC', 'Electric Utilities: Central', 0.1043, 0.01238, 7);
insert into Enterprises (id, name, type, emission_result, misc_emissions, country_id) values (43, 'Nader, Green and Gibson', 'n/a', 0.02407, 0.08523, 9);
insert into Enterprises (id, name, type, emission_result, misc_emissions, country_id) values (44, 'Mohr Inc', 'Coal Mining', 0.07562, 0.04556, 29);
insert into Enterprises (id, name, type, emission_result, misc_emissions, country_id) values (45, 'Robel, Mohr and Gulgowski', 'Department/Specialty Retail Stores', 0.08512, 0.04808, 12);
insert into Enterprises (id, name, type, emission_result, misc_emissions, country_id) values (46, 'Daugherty, Jenkins and Zieme', 'Major Pharmaceuticals', 0.09563, 0.07736, 3);
insert into Enterprises (id, name, type, emission_result, misc_emissions, country_id) values (47, 'Goodwin and Sons', 'Computer Software: Prepackaged Software', 0.07401, 0.00473, 3);
insert into Enterprises (id, name, type, emission_result, misc_emissions, country_id) values (48, 'Zboncak, Rolfson and Rippin', 'Telecommunications Equipment', 0.07957, 0.02406, 20);
insert into Enterprises (id, name, type, emission_result, misc_emissions, country_id) values (49, 'Larson Inc', 'Semiconductors', 0.05738, 0.08628, 28);
insert into Enterprises (id, name, type, emission_result, misc_emissions, country_id) values (50, 'Kris-O''Conner', 'Metal Fabrications', 0.04614, 0.05437, 14);
